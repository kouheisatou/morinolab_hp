...
// Tag constants
export const TAG_LIDAR: Tag = {
  id: 1,
  name: 'LiDAR/点群',
  name_english: 'LiDAR',
}
export const TAG_BLOCKCHAIN: Tag = {
  id: 2,
  name: 'ブロックチェーン',
  name_english: 'Blockchain',
}
export const TAG_CROWD: Tag = { id: 3, name: '人数推定', name_english: 'Crowd' }
export const TAG_V2X: Tag = { id: 4, name: 'V2X', name_english: 'V2X' }
export const TAG_WIFI: Tag = { id: 5, name: 'WiFi', name_english: 'WiFi' }
export const TAG_OTHER: Tag = { id: 6, name: 'その他', name_english: 'Other' }
...
export const members = [
  new Member(
    ...
    'Nao Imamura',
    'Incentive design for vehicle crowd-sensing road monitoring',
    2020,
    undefined,
    [TAG_CROWD],
    0,
  ...
  new Member(
    2,
    '佐々木敦史',
    'WiFi CSI を用いたドア開閉動作時の個人識別',
    'Tsuneyuki Sasaki',
    'Personal identification during door opening and closing using WiFi CSI',
    2020,
    undefined,
    [TAG_WIFI],
    0,
  ...
  new Member(
    ...
    'Shintaro Otomo',
    "Determining sitting posture of people using 3D point cloud captured from a bird's eye view",
    2020,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    ...
    'Ryota Ishida',
    'Detection of forward-looking pedestrians using multiple 3D LiDARs',
    2020,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    ...
    'Atsushi Isoya',
    'Real-time detection of frame-to-frame difference information in 3D point cloud data',
    2021,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    ...
    'Hiromichi Sato',
    'Channel capacity notification method for payment channel network on blockchain to achieve both low delay and privacy',
    2020,
    undefined,
    [TAG_BLOCKCHAIN],
    0,
  ...
  new Member(
    ...
    'Hiroto Sakai',
    "Estimation of crowd size from data captured from a bird's eye view using a few LiDARs",
    2021,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    8,
    '田上稜偉',
    '3次元点群データに付加する電子透かしの攻撃耐性向上法',
    'Ryota Tanaka',
    'Enhancing attack resistance of electronic watermarking in 3D point cloud data',
    2021,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    9,
    '池延一輝',
    '3次元点群データに付加する電子透かしの攻撃耐性評価',
    'Ichiro Ike',
    'Evaluation of attack resistance of electronic watermarking in 3D point cloud data',
    2022,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    10,
    '奥田真治',
    'Vehicle crowdsensing による道路状況監視における参加報酬の最適化',
    'Masahiro Okuda',
    'Optimization of incentive for road monitoring using vehicle crowdsensing',
    2022,
    undefined,
    [TAG_CROWD],
    0,
  ...
  new Member(
    11,
    '鈴木敬達',
    '3次元点群における曲率を用いた人の抽出と行動判別',
    'Keita Suzuki',
    'Extraction and behavior classification of people using curvature in 3D point cloud',
    2022,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    ...
    'Takuya Shizuka',
    'Introduction of reinforcement learning for cooperative vehicle speed control using V2X',
    2022,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    '3次元点群を用いた集団の人数推定',
    'Mika Aoyagi',
    'Estimation of crowd size using 3D point cloud',
    2022,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    ...
    'Akira Ito',
    'Evaluation of attack resistance of payment channel network on blockchain',
    2022,
    undefined,
    [TAG_BLOCKCHAIN],
    0,
  ...
  new Member(
    15,
    '川村大志',
    '短時間交通流予測による高速道路渋滞の早期検出の精度向上',
    'Daichi Kawamura',
    'Improving accuracy of early detection of traffic congestion using short-term traffic flow prediction',
    2022,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    16,
    '小林瑞宜',
    '少数のLiDARで俯瞰的に撮影した人流の人数推定',
    'Moe Kobayashi',
    'Estimation of crowd size using a few LiDARs',
    2022,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    ...
    'Tomoya Ima',
    'Evaluation of the impact of input series selection on prediction accuracy in early detection of traffic congestion using short-term traffic flow prediction',
    2022,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    '3次元点群を用いた人の姿勢判別',
    'Miki Shiozawa',
    'Determining posture of people using 3D point cloud',
    2022,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    ...
    'Ryo Tsukada',
    'Evaluation of control start time determination method using short-term traffic flow prediction for traffic congestion reduction using V2X-based cooperative vehicle speed control',
    2022,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    'Makoto Makino',
    'Channel group formation method for payment channel network on blockchain to reduce confirmation delay',
    2022,
    undefined,
    [TAG_BLOCKCHAIN],
    0,
  ...
  new Member(
    ...
    '車載LiDARによる道路標識検出',
    'Hina Sasaki',
    'Road sign detection using vehicular LiDAR',
    currentYear - 2,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    22,
    '田中悠斗',
    'ブロックチェーンスマートコントラクトのセキュリティ分析',
    'Yuto Tanaka',
    'Security analysis of blockchain smart contracts',
    currentYear - 2,
    undefined,
    [TAG_BLOCKCHAIN],
    0,
  ...
  new Member(
    ...
    '群衆行動予測モデルの改良',
    'Ai Takahashi',
    'Improving crowd behavior prediction models',
    currentYear - 2,
    undefined,
    [TAG_CROWD],
    0,
  ...
  new Member(
    ...
    'WiFi CSI を用いた屋内位置推定',
    'Kei Ito',
    'Indoor positioning using WiFi CSI',
    currentYear - 2,
    undefined,
    [TAG_WIFI],
    0,
  ...
  new Member(
    ...
    'V2X 通信による協調運転アルゴリズム',
    'Shun Ogawa',
    'Cooperative driving algorithms with V2X communication',
    currentYear - 2,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    '車車間通信プロトコルの開発',
    'Taro Yamada',
    'Development of V2V communication protocols',
    2017,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    '分散型台帳の性能評価',
    'Hanako Suzuki',
    'Performance evaluation of distributed ledger',
    2016,
    undefined,
    [TAG_BLOCKCHAIN],
    0,
  ...
  new Member(
    ...
    '点群データ圧縮アルゴリズムの設計',
    'Daisuke Sato',
    'Design of point-cloud compression algorithms',
    2015,
    undefined,
    [TAG_LIDAR],
    0,
  ...
  new Member(
    ...
    'クラウドソーシングによる交通データ収集',
    'Miku Kobayashi',
    'Traffic data collection via crowdsourcing',
    2014,
    undefined,
    [TAG_CROWD],
    0,
  ...
  new Member(
    ...
    'WiFi センサネットワークの省電力化',
    'Naoto Takagi',
    'Energy-efficient WiFi sensor networks',
    2013,
    undefined,
    [TAG_WIFI],
    0,
  ...
  new Member(
    39,
    '岩瀬一樹',
    'Wi-Fi CSIを用いたドア開閉動作の個人識別',
    'Kazuki Iwase',
    'Person identification using Wi-Fi CSI focusing on door opening/closing motion',
    2019,
    undefined,
    [TAG_WIFI],
    0,
  ...
  new Member(
    40,
    '高橋千彩季',
    'スマートウォッチを用いた書籍閲覧行動認識',
    'Chisaki Takahashi',
    'Recognition of browsing a book using smartwatches',
    2019,
    undefined,
    [TAG_OTHER],
    0,
  ...
  new Member(
    ...
    '車両速度予測と減速制御による渋滞緩和',
    'Tetsuya Fukumaru',
    'Traffic congestion mitigation by deceleration control with velocity forecasting',
    2019,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    '協調合流制御による事故渋滞の緩和',
    'Koki Saito',
    'Accident congestion mitigation by cooperative merging control',
    2019,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    '走行特性を考慮した都市部での迂回制御',
    'Haoming Li',
    'Urban detour control considering vehicle characteristics',
    2019,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    '速度制限変動制御による事故渋滞の緩和',
    'Shingo Koyama',
    'Accident congestion mitigation by speed limit variation control',
    2019,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    'Ryusei Aiura',
    'Area-dependent adaptive speed control for traffic accident congestion mitigation',
    2018,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    47,
    '白石遼平',
    '路車間通信を用いた自動運転車両の合流制御',
    'Ryohei Shiraishi',
    'Merge control for autonomous vehicles using V2X communications',
    2017,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    '高速道路合流部での車線移動制御',
    'Naoki Yamada',
    'Lane move control at highway merges using V2X',
    2017,
    undefined,
    [TAG_V2X],
    0,
  ...
  new Member(
    ...
    '高速道路サグ部渋滞時の迂回制御',
    'Hijiri Watanabe',
    'Detour control at sag congestion using V2X',
    2017,
    undefined,
    [TAG_V2X],
    0,
...
export const publications = [
  new Publication(
    ...
    'https://search.ieice.org/bin/summary.php?id=j108-b_3_100'
  ),
  new Publication(
    3,
    2024,
    '国際会議',
    ['石川華帆', '森野 博章', 'Andrew Morris', 'Asma Adnane'],
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. IEEE Vehicular Networking Conference',
    undefined,
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    '国内シンポジウム',
    ['佐藤衡平', '森野 博章'],
    'ブロックチェーンのペイメントチャネルネットワークにおける低遅延と送金情報の秘匿を両立する中継経路決定手法',
    undefined,
    '電子情報通信学会 NS研究会',
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. PerVehicle 2023 (co-located with IEEE PerCom)',
    undefined,
    undefined,
    undefined,
    'Mar. 2023',
  ...
  new Publication(
    ...
    'Sensors and Materials, Special Issue on Cyber–Physical Systems (CPS) and Internet of Things (IoT)',
    'Volume 33',
    'Number 1',
    'pp.89-107',
    '2021年1月',
  ...
  new Publication(
    ...
    2019,
    'ジャーナル論文',
    ['Saufi Bukhari', 'Ku Ruhana Ku-Mahamud', '森野 博章'],
    undefined,
  ...
  new Publication(
    ...
    '国内シンポジウム',
    ['田中優希', '森野 博章'],
    '[ポスター]スマートフォンの回転ベクトルセンサを利用した屋内PDRにおけるステップ単位でのユーザ移動状態認識',
    undefined,
    '電子情報通信学会 技術研究報告',
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. of the 8th International Conference on Electronics, Information, and Communication (ICEIC)',
    undefined,
    undefined,
    undefined,
    '2019年1月',
  ...
  new Publication(
    ...
    undefined,
    'Proc. of International Conference on Mobile Computing and Uniquitous Networking(ICMU)',
    undefined,
    undefined,
    undefined,
    '2018年10月',
  ...
  new Publication(
    ...
    undefined,
    'Proc. of International Technical Conference on Circuits/Systems, Computers and Communications(ITC-CSCC)',
    undefined,
    undefined,
    undefined,
    '2018年7月',
  ...
  new Publication(
    ...
    '招待講演',
    ['Hiroaki Morino'],
    'Autonomous Vehicle Communication and Control for Smart City',
    undefined,
    'International Conference on Electrical, Electronic, Communication and Control Engineering (ICEECC) 2018 Keynote',
    undefined,
    undefined,
    undefined,
    '2018年11月',
  ...
  new Publication(
    ...
    2017,
    '国際会議',
    ['Arfah Ahmad Hasbollah'],
    'Handover Algorithm Based VLP Using Mobility Prediction Database for Vehicular Networks',
    undefined,
    'Proc. of International Conference on Electrical, Electronic, Communication and Control Engineering(ICEECC)',
    undefined,
    undefined,
    undefined,
    '2017年12月',
  ...
  new Publication(
    ...
    undefined,
    'Proc. of IEEE Vehicular Networking Conference (IEEE VNC)',
    undefined,
    undefined,
    'pp.247-250',
    '2017年11月',
  ...
  new Publication(
    ...
    'Dynamic ACO-based Fault Tolerance in Grid Computing',
    undefined,
    'Proc. of The Seventh International Conference on Information Technology and Multimedia(ICIMU)',
    undefined,
    undefined,
    undefined,
    '2017年11月',
  ...
  new Publication(
    ...
    '長距離車々間通信による情報伝播を利用した自然渋滞解消支援の性能評価',
    undefined,
    '電子情報通信学会CQ基礎講座ワークショップ ポスターセッション',
    undefined,
    undefined,
    undefined,
    '2017年10月',
  ...
  new Publication(
    ...
    undefined,
    'Proc. of the 22nd Asia-Pacific Conference on Communications (APCC 2016)',
    undefined,
    undefined,
    undefined,
    '2016年8月',
  ...
  new Publication(
    ...
    2015,
    '国際会議',
    ['Hiroaki Morino', 'Takashi Inafune'],
  ...
  new Publication(
    ...
    '講演',
    ['森野 博章'],
    'ガラス球を用いた自由落下型深海探査機「江戸っ子1号」の開発と簡易型海中センシングへの応用に向けた展開',
    undefined,
    'インターネットカンファレンス2014',
    undefined,
    undefined,
  ...
  new Publication(
    ...
    '研究会・大会',
    ['藤本雅敏', '森野 博章'],
    '移動送信ノードに対応する無線メッシュ網の2階層マルチキャストルーティング ～ リンクストレスを考慮したマルチキャストルータの配置決定手法 ～',
    undefined,
    '電子情報通信学会技術研究報告 MoNA2014-11',
    undefined,
    undefined,
    undefined,
    '2014年5月',
  ...
  new Publication(
    ...
    undefined,
    'Proc. of the Sixth International Workshop on Autonomous Self-Organizing Networks (ASON 2013) in conjunction with IS-CANDAR 2013',
    undefined,
    undefined,
    undefined,
    '2013年12月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルネットワークとアプリケーション',
    undefined,
    undefined,
    undefined,
    '2014年3月',
  ...
  new Publication(
    ...
    '研究会・全国大会',
    ['飯尾亮真', '森野 博章'],
    '移動送信端末をサポートする無線メッシュネットワークの2階層マルチキャストにおけるデータ送信速度の評価',
    undefined,
    '電子情報通信学会東京支部学生研究発表会 No.85',
    undefined,
    undefined,
    undefined,
    '2014年3月',
  ...
  new Publication(
    ...
    '研究会・全国大会',
    ['向井淳貴', '森野 博章'],
    'Android端末の近接状態情報を利用したWiFiゲストアカウントの発行と管理',
    undefined,
    '電子情報通信学会技術研究報告 モバイルネットワークとアプリケーション MoNA2013-63',
    undefined,
    undefined,
    undefined,
    '2014年1月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 知的環境とセンサーネットワーク ASN2013-127',
    undefined,
    undefined,
    undefined,
    '2014年1月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルネットワークとアプリケーション MoNA2013-53',
    undefined,
    undefined,
    undefined,
    '2014年1月',
  ...
  new Publication(
    ...
    '研究会・全国大会',
    ['飯尾亮真', '森野 博章'],
    '無線メッシュネットワークにおける移動送信端末をサポートする2階層マルチキャスト方式とルータ配置手法の検討',
    undefined,
    '電子情報通信学会技術研究報告 モバイルネットワークとアプリケーション MoNA2013-21',
    undefined,
    undefined,
    undefined,
    '2013年8月',
  ...
  new Publication(
    ...
    '研究会・全国大会',
    ['稲船喬志', '森野 博章'],
    '車々間通信による渋滞緩和制御における異種RF併用の効果',
    undefined,
    '電子情報通信学会技術研究報告 知的環境とセンサーネットワーク ASN2013-33',
    undefined,
    undefined,
    undefined,
    '2013年5月',
  ...
  new Publication(
    ...
    2012,
    '国際会議・国際シンポジウム（査読有り)',
    ['Kien Duc Nguyen', 'Hoang Nam Nguyen', '森野 博章'],
    'Performance Study of Channel Allocation Schemes for Beyond 4G Cognitive Femtocell-Cellular Mobile Networks',
    undefined,
    'Proc. of the Fifth Workshop on Ad-Hoc Sensor and P2P (AHSP 2013) in conjunction with the 11th International Symposium on Autonomous Decentralized Systems (ISADS 2013)',
    'pp.209-214',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    '研究会・全国大会',
    ['大西辰弥', '森野 博章'],
    '物理網特性の推定に基づくネットワーク中心性とピア密度を考慮したP2Pマルチキャスト中継ピア選択の性能評価',
    undefined,
    '電子情報通信学会技術研究報告',
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. of the Fourth Workshop on Ad-Hoc Sensor and P2P (AHSP 2011) in conjunction with the 10th International Symposium on Autonomous Decentralized Systems (ISADS 2011)',
    'pp.489-494',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2011-55',
    undefined,
    undefined,
    undefined,
    '2012年3月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2011-38',
    undefined,
    undefined,
    undefined,
    '2012年1月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 アドホックネットワーク AN2011-62',
    undefined,
    undefined,
    undefined,
    '2012年1月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 ネットワークシステム NS2011-75',
    undefined,
    undefined,
    undefined,
    '2011年9月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2011-17',
    undefined,
    undefined,
    undefined,
    '2011年7月',
  ...
  new Publication(
    ...
    undefined,
    '日本機械学会ロボティクス・メカトロニクス講演会(ROBOMEC2011) 2P1-J02',
    undefined,
    undefined,
    undefined,
    '2011年5月',
  ...
  new Publication(
    ...
    2010,
    '国際会議・国際シンポジウム（査読有り)',
    ['Masugi Inoue', 'Masaaki Ohnishi', '森野 博章', 'Tohru Sanefuji'],
    'Fast Recovery from Link Failures and Blackout of A Managed Wireless Mesh for NerveNet',
    undefined,
    'Proc. of IEEE Global Telecommunication Conference (GLOBECOM 2011)',
    undefined,
    undefined,
    undefined,
    '2010年12月',
  ...
  new Publication(
    ...
    undefined,
    'Proc. of Annual IEEE International Conference on Personal, Indoor and Mobile Radio Communications (PIMRC 2010)',
    'pp. 2073-2078',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. of IEEE Wireless Communication and Networking Conference (WCNC 2010)',
    undefined,
    undefined,
    undefined,
    '2010年4月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2010-76',
    undefined,
    undefined,
    undefined,
    '2011年1月',
  ...
  new Publication(
    ...
    2011,
    '研究会・全国大会',
    ['岩永久志', '森野 博章', '斉藤佳子', '岩田綾子'],
    'MBMSにおける階層情報伝送のための一括FEC手法の検討',
    undefined,
    '電子情報通信学会技術研究報告 無線通信システム RCS2010-231',
    undefined,
    undefined,
    undefined,
    '2011年1月',
  ...
  new Publication(
    ...
    'ドップラーセンサを用いたジェスチャー識別手法の提案',
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2010-73',
    undefined,
    undefined,
    undefined,
    '2011年1月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 アドホックネットワーク AN2010-38',
    undefined,
    undefined,
    undefined,
    '2010年10月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2010-10',
    undefined,
    undefined,
    undefined,
    '2010年5月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2010-2',
    undefined,
    undefined,
    undefined,
    '2010年5月',
  ...
  new Publication(
    ...
    undefined,
    'Proc. of the 4th Symposium of South East Asia Technical University Consortium',
    undefined,
    undefined,
    undefined,
    '2010年2月',
  ...
  new Publication(
    ...
    2009,
    '国際会議・国際シンポジウム（査読有り)',
    ['Hiroyuki Kawamura', '森野 博章', 'Masugi Inoue', 'Tohru Sanefuji'],
  ...
  new Publication(
    ...
    undefined,
    'Proc. of IEEE Wireless Communication and Networking Conference (WCNC2009)',
    undefined,
    undefined,
    undefined,
    '2009年4月',
  ...
  new Publication(
    ...
    2010,
    '研究会',
    ['井上真杉', '大西真晶', '森野 博章', '実藤 亨'],
    '地域情報共有通信網NerveNetの分散型情報処理プラットフォーム機構',
    undefined,
    '電子情報通信学会技術報告 情報ネットワーク',
    undefined,
    undefined,
    undefined,
    '2010年3月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2009-60',
    undefined,
    undefined,
    undefined,
    '2010年1月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2009-70',
    undefined,
    undefined,
    undefined,
    '2010年1月',
  ...
  new Publication(
    ...
    2009,
    '研究会',
    ['長谷川真', '森野 博章', '岩田綾子', '三好憲一'],
    '協力中継における復号結果に誤りのあるパケットの適応中継方式に関する性能評価',
    undefined,
    '電子情報通信学会技術報告 無線通信システム',
    undefined,
    undefined,
    undefined,
    '2009年12月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術報告 モバイルマルチメディア通信 MoMuC2009-18',
    undefined,
    undefined,
    undefined,
    '2009年7月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術報告 モバイルマルチメディア通信 MoMuC2009-5',
    undefined,
    undefined,
    undefined,
    '2009年5月',
  ...
  new Publication(
    ...
    undefined,
    'ワイヤレステクノロジーパーク2009(WTP2009) アカデミアセッション',
    undefined,
    undefined,
    undefined,
    '2009年5月',
  ...
  new Publication(
    ...
    2008,
    '国際会議',
    ['森野 博章', 'Hiroyuki Kawamura', 'Masugi Inoue', 'Tohru Sanefuji'],
    'Load balanced multipath routing for wireless mesh networks : A step-by-step rate control approach',
    undefined,
    'The Third Workshop on Ad-Hoc Sensor and P2P(AHSP2009) in conjunction with ISADS 2009',
    undefined,
    undefined,
    undefined,
    '2009年3月',
  ...
  new Publication(
    ...
    2008,
    '国際会議',
    ['Masugi Inoue', 'Ved Kafle', '森野 博章', 'Tohru Sanefuji'],
    'Sensor Application Platform On A Novel Managed Wireless Mesh',
    undefined,
    'The Second Workshop on Wireless Mesh and Sensor Networks in conjunction with IEEE Globecom 2008',
    undefined,
    undefined,
    undefined,
    '2008年11月',
  ...
  new Publication(
    ...
    undefined,
    'International Symposium on Wireless Personal Multimedia Communications (WPMC2008)',
    undefined,
    undefined,
    undefined,
    '2008年9月',
  ...
  new Publication(
    ...
    2008,
    '国際会議',
    ['Hironori Sugino', '森野 博章'],
    "A study on reliable peer-to-peer streaming tree construction using records of peer's duration",
    undefined,
    'The Second International Conference on Communications and Electronics (HUT-ICCE 2008)',
    undefined,
    undefined,
    undefined,
    '2008年6月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 ネットワークシステム NS2008-162',
    'pp.105-110',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 ユビキタスセンサネットワーク USN2009-1',
    undefined,
    undefined,
    undefined,
    '2009年1月',
  ...
  new Publication(
    ...
    2008,
    '研究会',
    ['河村裕之', '井上真杉', '実藤 亨', '森野 博章'],
    'マルチチャネル無線メッシュ網における複数経路による適応負荷分散法の検討',
    undefined,
    '電子情報通信学会技術研究報告 アドホックネットワーク AN2008-53',
    'pp.7-12',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2008-16',
    'pp.11-14',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 ユビキタス・センサネットワーク USN2008-55',
    'pp.99-104',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア通信 MoMuC2008-28',
    'pp.13-18',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 アドホックネットワーク AN2008-11',
    'pp.53-56',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    '講演等',
    ['森野 博章'],
    'Wireless multihop networks: concepts, architectures and protocols',
    undefined,
    'The Second International Conference on Communications and Electronics (HUT-ICCE 2008)',
    undefined,
    undefined,
  ...
  new Publication(
    ...
    2009,
    '講演等',
    ['実藤 亨', '井上真杉', '大西真晶', '森野 博章'],
    'ユビキタスセンサーネットワークにおけるビジネス展開',
    undefined,
    '電子情報通信学会技術研究報告 ユビキタスセンサネットワーク USN2009-1',
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. of the 18th Annual IEEE International Symposium on Personal, Indoor and Mobile Radio Communications (PIMRC 2007)',
    undefined,
    undefined,
    undefined,
    '2007年9月',
  ...
  new Publication(
    ...
    '緊急情報の連絡を考慮したセンサネットワークの構築方式',
    undefined,
    '電子情報通信学会技術研究報告 モバイルマルチメディア(デモセッション)',
    undefined,
    undefined,
    undefined,
    '2008年1月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 ネットワークシステム NS2007-62',
    'pp.47-50',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    'ピアの滞在履歴を考慮したP2Pストリーミング配信ツリーの高信頼化',
    undefined,
    '電子情報通信学会通信ソサイエティ大会講演論文集 B-7-55',
    undefined,
    undefined,
    undefined,
    '2007年9月',
  ...
  new Publication(
    ...
    2007,
    '研究会・国内ワークショップ・全国大会',
    ['井上真杉', '中内清秀', '森野 博章', '実藤 亨'],
    '無線論理メッシュパスに基づくコミュニティ通信サービスプラットフォーム',
    undefined,
    '電子情報通信学会技術研究報告 アドホックネットワーク AN2007-26',
    'pp.67-72',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 アドホックネットワーク AN2007-2',
    'pp.7-10',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. of the 8th International Symposium on Autonomous Decentralized Systems (ISADS 2007)',
    'pp.519-525',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. of the 7th International Symposium on Autonomous Decentralized Systems (ISADS 2005)',
    'pp.675-680',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. of IEEE the 61st Semiannual Vehicular Technology Conference (VTC2005 spring)',
    'pp.2504-2508',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Lecture Notes on Computer Science 3823, Embedded and Ubiquitous Computing EUC 2005 Workshops',
    'pp.905-915',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告ネットワークシステムNS-102',
    undefined,
    undefined,
    undefined,
    '2005年9月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告ネットワークシステムNS2005-104',
    'pp.21-24',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会第3回アドホックネットワーク・ワークショップ予稿集',
    undefined,
    undefined,
    undefined,
    '2006年1月',
  ...
  new Publication(
    ...
    '学会誌論文',
    ['Ryokichi Onishi'],
    'Multi-Agent System for Dynamic Network Routing',
    undefined,
    'IEICE Transactions Vol.E84-B, No.10',
    'pp.2721-2728',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    2000,
    '学会誌論文',
    ['森野 博章', 'Udomkiat Bunworasate', 'Hitoshi Aida', 'Tadao Saito'],
    '可変速度TDM交換方式を用いた最低帯域保証機能を持つ動画像トラヒック制御方式',
    undefined,
    '電子情報通信学会論文誌 Vol.J83-B, No.12',
    'pp.1767-1775',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    2003,
    '国際会議',
    ['森野 博章', 'Tadao Saito', 'Mitsuo Nohara'],
    'Performance Evaluation of Base-station-assisted Link State Routing Method for Mobile Ad Hoc Networks',
    undefined,
    'Lecture Notes on Computer Science 2775 (Proc. of IFIP TC6 8th International Conference on Personal Wireless Communications (PWC 2003))',
    'pp.492-497',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Lecture Notes on Computer Science 1715 (Proc. of IFIP TC6 7th International Conference on Personal Wireless Communications (PWC 2002))',
    'pp.29-36',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    2001,
    '国際会議',
    ['Tamaree Nalin', '森野 博章', 'Hitoshi Aida', 'Tadao Saito'],
    'A Scalable and High Capacity Router on Multi-Dimension Crossbar Switch Principle',
    undefined,
    'Proc. of the 26th Annual IEEE Conference on Local Computer Networks (LCN 2001)',
    'pp.375-376',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    'Proc. of the Fifth International Symposium on Autonomous Decentralized Systems (ISADS 2001)',
    'pp.375-382',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    1997,
    '学会誌論文',
    ['森野 博章', 'Tadao Saito', 'Hitoshi Aida', '高橋淳一'],
    'ATM網の高速帯域予約プロトコルを用いた高能率動画像伝送方式',
    undefined,
    '電子情報通信学会論文誌 Vol.J80-B, No.10',
    'pp.735-741',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    1995,
    '学会誌論文',
    ['森野 博章', '青木輝勝', 'Hitoshi Aida', 'Tadao Saito'],
    '超高速LAN/MANのための高能率アクセス方式',
    undefined,
    '電子情報通信学会論文誌 Vol.J78-B, No.8',
    'pp.335-342',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    2000,
    '国際会議',
    ['森野 博章', 'Thai Thach Bao', 'Hitoshi Aida', 'Tadao Saito'],
    'Performance evaluation of variable length packet switch based on deflection routing and input port distribution',
    undefined,
    'Proc. of International Conference on Communication Technology (ICCT2000)',
    'pp.1050-1053',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    1999,
    '国際会議',
    ['森野 博章', 'Hitoshi Aida', 'Tadao Saito'],
    'A distributed routing algorithm in Clos network of variable bit rate TDM switch',
    undefined,
    "Proc. of the Fifth IFIP Conference on Intelligent Networks (Smartnet '99)",
    'pp.177-190',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    1997,
    '国際会議',
    ['森野 博章', 'Ban Yoshitake', 'Hitoshi Aida', 'Tadao Saito'],
    'Effective real-time video transmission system using fast bandwidth protocol over ATM networks',
    undefined,
    "Proc. of IEEE Pacific Rim Conference on Communications, Computers and Signal Processing (PACRIM '97)",
    'pp.721-724',
    undefined,
    undefined,
    undefined,
  ...
  new Publication(
    ...
    undefined,
    '情報処理学会モバイルコンピューティングとユビキタス通信研究会 MBL-30-7',
    undefined,
    undefined,
    undefined,
    '2004年9月',
  ...
  new Publication(
    ...
    2004,
    '研究会・国内ワークショップ',
    ['寺田真介', '久光光司', '三好匠', '森野 博章', '小川将克'],
    '片方向リンクを考慮したフラッディング領域制限型アドホックルーチングプロトコル',
    undefined,
    '電子情報通信学会技術研究報告 ネットワークシステム NS2004-26',
    undefined,
    undefined,
    undefined,
    '2004年5月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 ネットワークシステム NS2004-1',
    undefined,
    undefined,
    undefined,
    '2004年4月',
  ...
  new Publication(
    ...
    undefined,
    '情報処理学会 マルチメディア分散処理とモバイルワークショップ(DICOMO) 2003',
    undefined,
    undefined,
    undefined,
    '2003年6月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 無線通信システム RCS2002-23',
    undefined,
    undefined,
    undefined,
    '2002年4月',
  ...
  new Publication(
    ...
    undefined,
    '電子情報通信学会技術研究報告 ネットワークシステム NS2001-117',
    undefined,
    undefined,
    undefined,
    '2001年9月',
  ...
  new Publication(
    ...
    2000,
    '全国大会',
    ['中川幸洋', '森野 博章', 'Hitoshi Aida', 'Tadao Saito'],
...
// News / Announcements / Awards unified list
export const newsItems: NewsItem[] = [
  new NewsItem(
    1,
    '2025-06-01',
    'オープンキャンパス開催のお知らせ',
    'Open Campus Announcement',
    'img/sample/opencampus.png'
  ),
  new NewsItem(
    2,
    '2025-05-20',
    'B4配属説明会のお知らせ',
    'Orientation for New B4 Students',
    'img/sample/orientation.png'
  ),
  new NewsItem(
    3,
