      ...
      <SectionWrapper className='py-32'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            Comprehensive courses covering fundamental concepts to advanced
            topics in computer science and emerging technologies.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {filteredLectures.map((lecture) => {
            ...
            return (
              ...
              >
                {/* サムネイル */}
                <div className='w-full h-48 overflow-hidden mb-4 bg-gradient-to-br from-gray-800 to-gray-900 -mx-6 -mt-6 mb-2 rounded-t-lg'>
                  <Image
                    src={getStaticPath(
